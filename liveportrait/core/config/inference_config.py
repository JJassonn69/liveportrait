...
class InferenceConfig(PrintableConfig):
    ...
    mask_crop: ndarray = field(default_factory=lambda: cv2.imread(make_abs_path('../utils/resources/mask_template.png'), cv2.IMREAD_COLOR))  # Changed to use default_factory
